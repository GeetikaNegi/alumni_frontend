      ...
      <nav className={`upr_nav ${sticky ? "sticky" : ""}`}>
        ...
        <ul className={`inner_ul ${menuOpen ? "open" : ""}`}>
          ...
          <li>
            ...
            <ul
              id={`${submenu_about ? "career_submenu" : "abc"}`}
              className={`${sticky ? "sticky" : ""}`}
            >
              <li>
                <NavLink
              ...
              <li>
                <NavLink to='/ourteam' onClick={toggleSubmenu_about}>
                  Our Team
                </NavLink>
              </li>
            </ul>
          ...
          <li>
            ...
            <ul id={`${submenu_career ? "career_submenu" : "abc"}`}>
              <li>
                <NavLink to='/jobs' onClick={toggleSubmenu_career}>
                  Jobs
                </NavLink>
              </li>
              <li>
                <NavLink to='/internship' onClick={toggleSubmenu_career}>
                  Internship
                </NavLink>
              </li>
            </ul>
          ...
          <li>
            ...
            <ul id={`${submenu_connect ? "career_submenu" : "abc"}`}>
              <li>
                <NavLink to='/alumnidirectory' onClick={toggleSubmenu_connect}>
                  Year Book
                </NavLink>
              </li>
              <li>
                <NavLink to='/invitebatchmate' onClick={toggleSubmenu_connect}>
                  Invite Batchmate
                </NavLink>
              </li>
            </ul>
