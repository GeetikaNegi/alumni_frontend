...
export const NavbarNew = () => {
  ...
  return (
    <>
      <img className={`${sticky ? "sticky" : ""}`} id="top-img" src={top} alt="Sorry" />
      <nav className={`upr_nav ${sticky ? "sticky" : ""}`} ref={menuRef}> {/* Pass ref to the menu container */}
        ...
        <ul className={`inner_ul ${menuOpen ? "open" : ""}`}>
          ...
          <li>
            <span onClick={toggleSubmenu_about}>
              <NavLink>About <img className="downarr" src={downArrow} /></NavLink>
            </span>
          ...
          <li>
            <span onClick={toggleSubmenu_career}>
              <NavLink>Career <img className="downarr" src={downArrow} /></NavLink>
            </span>
            <ul id={`${submenu_career ? "career_submenu" : "abc"}`}>
              <li><NavLink to="/jobs" onClick={()=>{
                toggleSubmenu_career();
                setMenuOpen(false);
              }}>Jobs</NavLink></li>
            <li><NavLink to="/internship" onClick={()=>{
              toggleSubmenu_career();
              setMenuOpen(false);
            }}>Internship</NavLink></li>
          </ul>
        </li>
        <li>
        <span onClick={toggleSubmenu_connect}><NavLink to="/">Connect <img className="downarr" src={downArrow}/></NavLink></span>
          <ul id={`${submenu_connect? "career_submenu": "abc"}`}>
            <li><NavLink to="/alumnidirectory" onClick={()=>{
              toggleSubmenu_connect();
              setMenuOpen(false);
            }}>Year Book</NavLink></li>
            <li><NavLink to="/invitebatchmate" onClick={()=>{
              toggleSubmenu_connect();
              setMenuOpen(false);
            }}>Invite Batchmate</NavLink></li>
          </ul>
        </li>
        <li>
          <span onClick={() => setMenuOpen(!menuOpen)}>
